...
def test_defaults():
    ...
    assert set(cfg.providers) == {"claude", "codex", "gemini", "deepseek", "copilot", "glm", "openrouter"}
...
def test_default_config_toml_is_valid_and_matches_defaults():
    ...
    assert set(data["providers"]) == {"claude", "codex", "gemini", "deepseek", "copilot", "glm", "openrouter"}
